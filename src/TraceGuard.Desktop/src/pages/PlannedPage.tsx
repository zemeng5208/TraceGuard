...
const keyMap: Record<Exclude<PageId, 'dashboard' | 'terminal' | 'applications' | 'processes' | 'services' | 'startup' | 'settings' | 'rules'>, string> = {
  disk: 'disk', browser: 'browser', network: 'network', update: 'windowsUpdate', files: 'files', registry: 'registry', restore: 'restore',
};

export function PlannedPage({ page, settings }: { page: Exclude<PageId, 'dashboard' | 'terminal' | 'applications' | 'processes' | 'services' | 'startup' | 'settings' | 'rules'>; settings: AppSettings }) {
